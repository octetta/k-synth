...
typedef struct {
    ...
    double lfo_phase;
    double lfo_freq;
    double mod_depth_freq; // Hz deviation
    double mod_depth_vol;  // Linear amplitude deviation
    double mod_depth_pan;  // Panning deviation
...
void skred_voice_stop(skred_voice_t* p_voice); // Hard kill
